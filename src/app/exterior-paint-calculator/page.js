...
export default function ExteriorPaintCalculatorPage() {
  const data = getCalculatorData('exterior-paint-calculator');
  ...
  blogTitle="Exterior Paint Coverage"
  description="Coverage by siding type: vinyl (375 sq ft/gal), wood (225-325 sq ft/gal), stucco (150-275 sq ft/gal) with PCA/MPI standards."
/>
