      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col lg:flex-row gap-8 max-w-7xl mx-auto">
          ...
          <div className="flex-1 max-w-4xl lg:mx-auto">
            ...
            <CalculatorBlogLink 
              blogSlug="concrete-calculation-guide"
              blogTitle="Concrete Calculation"
              description="ACI 318 standards, bag yields (60lb/80lb), ready-mix specifications, and IRC/IBC code requirements for slabs, footings, and walls."
            />
          ...
          <div className="w-full lg:w-80 flex-shrink-0">
            <div className="lg:sticky lg:top-8">
              <DumpsterSidebar calculatorType="concrete" />
            </div>
          </div>
        </div>
      </div>
